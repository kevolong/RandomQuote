...
function getQuote() {
  $.ajax({
    ...
    success: function(result) {
      currentQuote = result;
      $("#quote")
        .html(currentQuote.quote)
        .addClass("animated fadeInLeft");
      $("#author")
        .html("- " + currentQuote.author)
        .addClass("animated fadeInLeft");

      $("#tweet").attr(
        "href",
        "https://twitter.com/intent/tweet?hashtags=RandomQuoteTime&text=" +
      ...
      $("#tumblr").attr(
        "href",
        "https://www.tumblr.com/widgets/share/tool?posttype=quote&tags=RandomQuotes&caption=" +
          encodeURIComponent(currentQuote.author) +
          "&content=" +
          encodeURIComponent(currentQuote.quote) +
          "&canonicalUrl=https%3A%2F%2Fwww.tumblr.com%2Fbuttons&shareSource=tumblr_share_button"
      );
      $("#reddit").attr(
        "href",
        "https://www.reddit.com/r/quotes/submit?&title=" +
          encodeURIComponent('"' + currentQuote.quote + '" -  ' + currentQuote.author)
      );
